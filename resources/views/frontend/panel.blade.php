            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="top-slider owl-carousel owl-theme top-slider-wrap">
                        ...
                        <div class="slider-item bg-white rounded p-4">
                            <figure class="position-relative">
                                <img src="{{url('frontend/img/blog/ecom.jpg')}}" alt="" class="w-100 rounded">
                                <figcaption class="tp_top position-absolute p-4">
                                    <span>20 مرداد</span>
                                </figcaption>
                                <figcaption class="tp_bottom position-absolute p-4">
                        ...
                        <div class="slider-item bg-white rounded p-4">
                            <figure class="position-relative">
                                <img src="{{url('frontend/img/blog/podcast.jpg')}}" alt="" class="w-100 rounded">
                                <figcaption class="tp_top position-absolute p-4">
                                    <span>20 مرداد</span>
                                </figcaption>
                                <figcaption class="tp_bottom position-absolute p-4">
                        ...
                        <div class="slider-item bg-white rounded p-4">
                            <figure class="position-relative">
                                <img src="{{url('frontend/img/blog/btstrap.jpg')}}" alt="" class="w-100 rounded">
                                <figcaption class="tp_top position-absolute p-4">
                                    <span>20 مرداد</span>
                                </figcaption>
                                <figcaption class="tp_bottom position-absolute p-4">
                        ...
                        <div class="slider-item bg-white rounded p-4">
                            <figure class="position-relative">
                                <img src="{{url('frontend/img/blog/buisiness.jpg')}}" alt="" class="w-100 rounded">
                                <figcaption class="tp_top position-absolute p-4">
                                    <span>20 مرداد</span>
                                </figcaption>
                                <figcaption class="tp_bottom position-absolute p-4">
