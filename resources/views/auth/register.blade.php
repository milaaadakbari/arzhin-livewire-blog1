...
<div class="form-wrapper">
    ...
    <form method="POST" action="{{route('register')}}">
        ...
        <div class="form-group">
            <input type="email" name="email" class="form-control text-left" placeholder="ایمیل" dir="ltr">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="password" name="password_confirmation" class="form-control text-left"
                   placeholder="تکرار رمز عبور" dir="ltr">
        </div>
        <button type="submit" class="btn btn-primary btn-block">ثبت نام</button>
        <hr>
        <p class="text-muted">حساب کاربری دارید؟</p>
        <a href="#" class="btn btn-outline-light btn-sm">وارد شوید!</a></form>
</div>
